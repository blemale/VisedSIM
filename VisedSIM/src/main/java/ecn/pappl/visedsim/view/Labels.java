...
public final class Labels {
    ...
    //FileLoader
    public final static String FILE_LOADER_TITLE = "Chargement d'une liste de projets";
    public final static String LIST_PROJECT = "Liste des projets";
    public final static String NEW_PROJECT_LIST = "Nouvelle liste de projets";
    public final static String CHOOSE_NEW_LIST_BUTTON = "Choisir...";
    public final static String LOAD_SAVED_LIST_BUTTON = "Charger";
    public final static String LOAD_NEW_LIST_BUTTON = "Charger";
    ...
    public final static String CONFIDENTIAL_PROJECTS_TITLE = "Imprimer - Projets en conflits";
    ...
    public final static String SEEKING_PROJECTS_POPUP = "Pas d'acronyme commençant par ces lettres";
    public final static String SEEKING_PROJECTS_VALIDATION = "Veuillez choisir un projet";
